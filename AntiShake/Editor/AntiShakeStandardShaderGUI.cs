...
// Modified by BlueAmulet to merge Autodesk GUI and add Cull Mode support
...
namespace AntiShake
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent cullModeText = EditorGUIUtility.TrTextContent("Cull Mode", "Culling Mode");
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            else if (specularMap != null && metallicMap != null && metallic != null)
                m_WorkflowMode = WorkflowMode.Autodesk;
        ...
        void DoSpecularMetallicArea()
        {
            ...
            else if (m_WorkflowMode == WorkflowMode.Metallic || m_WorkflowMode == WorkflowMode.Autodesk)
            {
            ...
            if (m_WorkflowMode == WorkflowMode.Autodesk)
            {
                m_MaterialEditor.TexturePropertySingleLine(Styles.roughnessText, specularMap, specularMap.textureValue != null ? null : smoothness);
            }
            else
            {
        ...
        static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
        {
            ...
            if (workflowMode == WorkflowMode.Specular || workflowMode == WorkflowMode.Autodesk)
                SetKeyword(material, "_SPECGLOSSMAP", material.GetTexture("_SpecGlossMap"));
            else if (workflowMode == WorkflowMode.Metallic || workflowMode == WorkflowMode.Autodesk)
