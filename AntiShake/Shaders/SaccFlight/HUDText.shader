...
// Modified by BlueAmulet to use UnityObjectToClipPosAlt and enums

Shader "AntiShake/SF-1/HUDText"
{
	Properties
	{
		...
		[Enum(UnityEngine.Rendering.StencilOp)] _StencilOp ("Stencil Operation", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(appdata_t IN)
			{
				...
				OUT.vertex = UnityObjectToClipPosAlt(OUT.worldPosition);
